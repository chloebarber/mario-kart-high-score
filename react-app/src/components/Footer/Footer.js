        ...
        <>
            <div className="footer-div">
                <div className="logo-div">
                    <img src="https://pbs.twimg.com/media/EXhiwSYWAAADECY.png" className="logo-bowser" alt='baby bowser'></img>
                </div>
                ...
                <div className="chloe-developer">
                    ...
                    <a href="https://github.com/chloebarber"><img src="https://cdn3.iconfinder.com/data/icons/free-social-icons/67/linkedin_circle_black-512.png" alt="LinkedIn icon" className="linkedin-icon" /></a>
                </div>
